...
const notTaxable = ['book', 'chocolate bar', 'packet of headache pills', 'Chocolate']
    ...
    static getTax = async (req, res) => {
        ...
        findTotalItems.forEach(item => {
            ...
            if ( notTaxable.includes(item.itemName) ) {
                ...
                findTaxAndNewAmount(ppnItem, item, 0.10)
            }
        })

        let totalAllArray = [...noTaxItem, ...importTaxItem, ...doubleTaxItem, ...ppnItem, totalTaxAmount]
